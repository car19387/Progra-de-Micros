...
isr:
    ...
    btfsc ((PIR1) and 07Fh), 0 ; Testear si esta encendida la bandera para...
    call int_tmr1 ; Ir a la subrutina del TMR1
    btfsc ((PIR1) and 07Fh), 1 ; Testear si esta encendida la bandera para...
...
config_tmr0:
    ...
    bcf ((OPTION_REG) and 07Fh), 0 ; Bits para prescaler (1:2) (Bits de OPTION_REG)
