...
loop:
    ...
    btfss ((INTCON) and 07Fh), 2 ; Revisar la bandera de interrupción
    goto $-5
...
config_tmr0: ; Configuración de Timer0
    ...
    bcf ((OPTION_REG) and 07Fh), 0 ; Bits para prescaler (1:128) (Bits de OPTION_REG)
...
reiniciar_tmr0: ; Reinicio de Timer0
    ...
    bcf ((INTCON) and 07Fh), 2 ; Bit de interrupción por overflow (Bit de INTCON)
    return
...
config_reloj: ; Configuración de reloj interno
    ...
    bcf ((OSCCON) and 07Fh), 4 ; Configuración del oscilador a 250kH
    bsf ((OSCCON) and 07Fh), 0 ; Seleccionar el reloj interno para el sistema del reloj
    return
